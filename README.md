...
```sh
  cd my-folder
  git clone https://github.com/unorjikingsley/metrics-app.git
```
...
- Credit to Nelson Sakwa(https://www.behance.net/sakwadesignstudio) 
- Author of the original design(https://www.behance.net/gallery/31579789/Ballhead-App-(Free-PSDs))
